        ...
        container.innerHTML = `
            <div class="screen">
                ...
                <div class="sequence-flow">
                    <div class="sequence-item reaction">
                        <div class="sequence-number">1</div>
                        <div class="sequence-icon">⚡</div>
                        <div class="sequence-label">Processing Speed</div>
                    </div>
                    <div class="sequence-arrow">→</div>
                    <div class="sequence-item memory">
                        <div class="sequence-number">2</div>
                        <div class="sequence-icon">🧠</div>
                        <div class="sequence-label">Memory & Recall</div>
                    </div>
                    <div class="sequence-arrow">→</div>
                    <div class="sequence-item calculation">
                        <div class="sequence-number">3</div>
                        <div class="sequence-icon">🔢</div>
                        <div class="sequence-label">Attention & Calculation</div>
                    </div>
                    <div class="sequence-arrow">→</div>
                    <div class="sequence-item visuospatial">
                        <div class="sequence-number">4</div>
                        <div class="sequence-icon">🧩</div>
                        <div class="sequence-label">Visuospatial Processing</div>
                    </div>
                </div>

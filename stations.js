        ...
        container.innerHTML = `
            <div class="screen">
                ...
                <div class="card mt-16">
                    <h3 style="font-size:14px; font-weight:600; margin-bottom:8px;">Correct Order</h3>
                    <p style="font-size:13px; color:var(--text-secondary);">${data.presentedOrder.map(id => CONFIG.memory.items.find(i => i.id === id).label).join(' → ')}</p>
                    <h3 style="font-size:14px; font-weight:600; margin-bottom:8px; margin-top:12px;">Your Order</h3>
                    <p style="font-size:13px; color:var(--text-secondary);">${data.submittedOrder.map(id => CONFIG.memory.items.find(i => i.id === id).label).join(' → ')}</p>
                </div>
...
const CalculationStation = {
            ...
            <div class="screen screen-center">
                ...
                <div class="instructions-box">
                    <ol>
                        ...
                        <li>You will repeatedly subtract the <strong>SAME</strong> number.</li>
                        <li>Complete <strong>FIVE</strong> calculations as quickly and accurately as possible.</li>
                    </ol>
                </div>
    ...
    start() {
        ...
        this.subtractionValue = CONFIG.calculation.subtractionOptions[randomInt(0, 1)];
        ...
        container.innerHTML = `
            <div class="screen">
                <div class="calc-header">
                    ...
                    <div class="instruction">Subtract <strong>${this.subtractionValue}</strong> each time</div>
                </div>
